...
local function on_heist_start()
    ...
    CustomHints.welcome = {
        ...
        welcome_hox_1 --[[The Breakout]] = {  },
        welcome_spa --[[Brooklyn 10-10]] = {  },
        welcome_vit --[[The White House]] = { "THE BIG ONE!" },
        welcome_mia_2 --[[Four Floors]] = {  },
        welcome_ranc --[[Midland Ranch]] = {  },
        ...
        welcome_jolly --[[Aftershock]] = { "Doing this, makes you are partly responsible for lootboxes.", "I love Vlad, but fuck him for these safes." },
        ...
        welcome_mad --[[Boiling Point]] = { "Welcome to the motherland!" },
        ...
        welcome_kenaz --[[Golden Grin Casino]] = { "Let's go gambling!" },
        ...
        welcome_election_day_3 --[[Breaking Ballot]] = {  },
        ...
        welcome_pbr2 --[[Birth of Sky]] = { "It's kinda cramped in here.", "Are we there yet? My back hurts." },
    ...
    if not Global.hint_weights.welcome_hint_modifier then
        Global.hint_weights.welcome_hint_modifier = 1
    end
    local modifier_step = 0.7 / 60
    local function increase_chance_loop()
        DelayedCalls:Add("welcome_hint_chance_increase", 60, function()
            Global.hint_weights.welcome_hint_modifier = Global.hint_weights.welcome_hint_modifier + modifier_step
            increase_chance_loop()
        end)
    end
    ...
    if CustomHints.welcome[hint_id] and #CustomHints.welcome[hint_id] > 0 then
        local chance = #CustomHints.welcome[hint_id] / 10 * Global.hint_weights.welcome_hint_modifier
        ...
        if math.random() < chance then
            ...
            Global.hint_weights.welcome_hint_modifier = 1 - modifier_step * 15
        end
    else
        LogPrivateChat("This heist has no welcome hint messages.")
    end
    if not is_testing_map then
        increase_chance_loop()
    end
